...
<title>
    @isset($formulaData['name'])
      {{ $formulaData['name'] }} Benchmark Calculator
    @else
...
<div class="py-16 bg-gradient-to-br from-blue-50 to-purple-50 min-h-screen">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            ...
            <h1 class="text-4xl font-bold text-gray-900 mb-4">{{ $formulaData['name'] }}</h1>
        ...
        <div class="bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-gray-100">
            <form id="benchmarkForm" action="{{ route('benchmark.compute', $formula) }}" method="POST">
                @csrf
                <div class="mb-8">
